...
import { z } from 'zod'
import { Eye, EyeOff, Mail, Lock, Chrome, Github, ArrowLeft, Info } from 'lucide-react'
...
const MockLoginPage: React.FC<MockLoginPageProps> = ({ onSwitchToRegister, onSwitchToReset, onBack }) => {
        ...
        <Card className="shadow-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-xs text-blue-800 dark:text-blue-200 font-medium mb-1">🚀 Demo Mode</p>
              <p className="text-xs text-blue-700 dark:text-blue-300">This is a demo authentication system. Use the credentials above or create a new account to explore the dashboard.</p>
            </div>
          </CardContent>
        </Card>
      </motion.div>

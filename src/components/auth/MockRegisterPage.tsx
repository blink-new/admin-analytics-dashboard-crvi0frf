...
import { z } from 'zod'
import { Eye, EyeOff, Mail, Lock, User, Chrome, Github, ArrowLeft, Info } from 'lucide-react'
...
const MockRegisterPage: React.FC<MockRegisterPageProps> = ({ onSwitchToLogin, onBack }) => {
          ...
          <CardContent className="space-y-6">
            ...
            <Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/20">
              ...
              <AlertDescription className="text-green-800 dark:text-green-200 text-sm">
                <strong>Demo Mode:</strong> Create any account to explore the dashboard. Your data will be stored locally in your browser.
              </AlertDescription>
            </Alert>
